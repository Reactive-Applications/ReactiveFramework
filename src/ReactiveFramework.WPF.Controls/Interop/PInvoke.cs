...
{
    #region ExternMethodes

    [DllImport(Libraries.User32, ExactSpelling = true)]
    [DefaultDllImportSearchPaths(DllImportSearchPath.System32)]
    private static extern unsafe int MapWindowPoints(HWND hWndForm, HWND hWndTo, RECT* lpPoints, uint cPoints);
    ...
    [DllImport(Libraries.Shell32, CallingConvention = CallingConvention.StdCall)]
    ...
    public static unsafe bool GetMappedClientRect(HWND hwnd, out RECT rResult)
    {
        RECT rect = default;
        rResult = rect;
    ...
    public static unsafe void RaiseMouseMessage(IntPtr hWnd, WM msg, nuint wParam, nint lParam, bool send = true)
    {
        ...
        ScreenToClient(new(hWnd), ref point);
