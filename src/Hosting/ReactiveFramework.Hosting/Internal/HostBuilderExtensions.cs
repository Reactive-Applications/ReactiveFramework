...
internal static class HostBuilderExtensions
{
    ...
    internal static void ApplyDefaultAppConfiguration(HostBuilderContext context, IConfigurationBuilder configurationBuilder, string[]? args)
    {
    ...
    internal static void AddDefaultLogging(HostBuilderContext context, ILoggingBuilder logging)
    {
